...
import { Search, Loader2, Mail, UserCheck, ShieldCheck } from 'lucide-react';
                  ...
                  <tr key={u.id} className="hover:bg-gray-50/50 transition-colors">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div className="w-9 h-9 rounded-full bg-[#FFE6D4] text-[#CD2C58] font-bold flex items-center justify-center text-sm shrink-0">
                    ...
                    <td className="px-6 py-4">
                      <span className={`px-2.5 py-1 rounded-full text-xs font-bold ${u.role === 'ADMIN' ? 'bg-purple-100 text-purple-800' : u.role === 'VENDOR' ? 'bg-blue-100 text-blue-800' : 'bg-emerald-100 text-emerald-800'}`}>
                        {u.role || 'CUSTOMER'}
                      </span>
                    </td>
